// ------------------------------------------------------------------------------------------------------
// <copyright file="IAcalaExplorerClient.cs" company="Nomis">
...
{
    /// <summary>
    /// Acala Explorer client.
    /// </summary>
    public interface IAcalaExplorerClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="AcalaExplorerAccount"/>.</returns>
        Task<AcalaExplorerAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="AcalaExplorerAccount"/>.</returns>
        Task<AcalaExplorerAccount> GetTokenBalanceAsync(string address, string contractAddress);
