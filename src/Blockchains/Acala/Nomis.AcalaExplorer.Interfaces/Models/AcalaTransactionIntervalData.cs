// ------------------------------------------------------------------------------------------------------
// <copyright file="AcalaTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.AcalaExplorer.Interfaces.Models
{
    ...
    public class AcalaTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToAca();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToAca();
        ...
        public decimal AmountInSumValue => AmountInSum.ToAca();
