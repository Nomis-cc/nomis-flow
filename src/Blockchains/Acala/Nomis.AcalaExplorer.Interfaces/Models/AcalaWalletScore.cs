// ------------------------------------------------------------------------------------------------------
// <copyright file="AcalaWalletScore.cs" company="Nomis">
...
namespace Nomis.AcalaExplorer.Interfaces.Models
{
    ...
    /// Acala wallet score.
    /// </summary>
    public class AcalaWalletScore :
        IWalletScore<AcalaWalletStats, AcalaTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public AcalaWalletStats? Stats { get; set; }
    }
}