// ------------------------------------------------------------------------------------------------------
// <copyright file="AcalaStatCalculator.cs" company="Nomis">
...
namespace Nomis.AcalaExplorer.Calculators
{
    /// <summary>
    /// Acala wallet stats calculator.
    /// </summary>
    internal sealed class AcalaStatCalculator :
        IStatCalculator<AcalaWalletStats, AcalaTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<AcalaExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<AcalaExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public AcalaStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<AcalaExplorerAccountNormalTransaction> transactions,
            IEnumerable<AcalaExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public AcalaWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToAca() : 0),
                BalanceChangeInLastMonth = IStatCalculator<AcalaTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<AcalaTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
