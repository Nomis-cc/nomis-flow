...
namespace Nomis.AcalaExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Acala Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddAcalaExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<AcalaExplorerSettings>(configuration);
            return services
                .AddTransient<IAcalaExplorerClient, AcalaExplorerClient>()
                .AddTransientInfrastructureService<IAcalaScoringService, AcalaExplorerService>();
        }
    }
}