// ------------------------------------------------------------------------------------------------------
// <copyright file="AlgorandTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.AlgoExplorer.Interfaces.Models
{
    ...
    public class AlgorandTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToAlgo();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToAlgo();
        ...
        public decimal AmountInSumValue => AmountInSum.ToAlgo();
