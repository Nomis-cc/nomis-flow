// ------------------------------------------------------------------------------------------------------
// <copyright file="AlgorandWalletScore.cs" company="Nomis">
...
{
    /// <summary>
    /// Algorand wallet score.
    /// </summary>
    public class AlgorandWalletScore :
        IWalletScore<AlgorandWalletStats, AlgorandTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public AlgorandWalletStats? Stats { get; set; }
    }
}