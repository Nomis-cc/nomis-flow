// ------------------------------------------------------------------------------------------------------
// <copyright file="AptosTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.AptoslabsExplorer.Interfaces.Models
{
    ...
    public class AptosTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToAptos();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToAptos();
        ...
        public decimal AmountInSumValue => AmountInSum.ToAptos();
