...
namespace Nomis.AptoslabsExplorer.Interfaces.Models
{
    ...
    /// Aptos wallet stats.
    /// </summary>
    public sealed class AptosWalletStats :
        IWalletCommonStats<AptosTransactionIntervalData>,
        ...
        IWalletContractStats
    {
        ...
        /// <inheritdoc/>
        public IEnumerable<AptosTransactionIntervalData>? TurnoverIntervals { get; init; }
        ...
        public IEnumerable<string> ExcludedStatDescriptions =>
            IWalletCommonStats<AptosTransactionIntervalData>.ExcludedStatDescriptions.Union(new List<string>
            {
