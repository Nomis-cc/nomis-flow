// ------------------------------------------------------------------------------------------------------
// <copyright file="AptoslabsExplorerCoinActivitiesRequest.cs" company="Nomis">
...
{
    /// <summary>
    /// Aptoslabs Explorer coin activities request.
    /// </summary>
    public class AptoslabsExplorerCoinActivitiesRequest
    {
        /// <summary>
        /// Owner address.
        /// </summary>
