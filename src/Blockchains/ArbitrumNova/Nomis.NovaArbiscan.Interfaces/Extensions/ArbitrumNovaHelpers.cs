// ------------------------------------------------------------------------------------------------------
// <copyright file="ArbitrumNovaHelpers.cs" company="Nomis">
...
namespace Nomis.NovaArbiscan.Interfaces.Extensions
{
    /// <summary>
    /// Extension methods for Arbitrum Nova.
    /// </summary>
    public static class ArbitrumNovaHelpers
    {
        /// <summary>
        ...
        public static string GetTokenUid(this INovaArbiscanAccountNftTokenEvent token)
        {
