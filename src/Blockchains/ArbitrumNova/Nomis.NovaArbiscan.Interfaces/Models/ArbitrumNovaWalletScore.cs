// ------------------------------------------------------------------------------------------------------
// <copyright file="ArbitrumNovaWalletScore.cs" company="Nomis">
...
{
    /// <summary>
    /// Arbitrum Nova wallet score.
    /// </summary>
    public class ArbitrumNovaWalletScore :
        IWalletScore<ArbitrumNovaWalletStats, ArbitrumNovaTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public ArbitrumNovaWalletStats? Stats { get; set; }
    }
}