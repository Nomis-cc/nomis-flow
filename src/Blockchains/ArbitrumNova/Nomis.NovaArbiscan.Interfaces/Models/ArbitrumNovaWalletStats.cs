// ------------------------------------------------------------------------------------------------------
// <copyright file="ArbitrumNovaWalletStats.cs" company="Nomis">
...
{
    /// <summary>
    /// Arbitrum Nova wallet stats.
    /// </summary>
    public sealed class ArbitrumNovaWalletStats :
        BaseEvmWalletStats<ArbitrumNovaTransactionIntervalData>,
        IWalletNftStats
    {
        /// <inheritdoc/>
