...
namespace Nomis.NovaArbiscan.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Nova arbiscan service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddNovaArbiscanService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<NovaArbiscanSettings>(configuration);
            return services
                .AddTransient<INovaArbiscanClient, NovaArbiscanClient>()
                .AddTransientInfrastructureService<IArbitrumNovaScoringService, NovaArbiscanService>();
        }
    }
}