// ------------------------------------------------------------------------------------------------------
// <copyright file="AstarTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.AstarExplorer.Interfaces.Models
{
    ...
    public class AstarTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToAstr();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToAstr();
        ...
        public decimal AmountInSumValue => AmountInSum.ToAstr();
