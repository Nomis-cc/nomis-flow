// ------------------------------------------------------------------------------------------------------
// <copyright file="AstarStatCalculator.cs" company="Nomis">
...
namespace Nomis.AstarExplorer.Calculators
{
    /// <summary>
    /// Astar wallet stats calculator.
    /// </summary>
    internal sealed class AstarStatCalculator :
        IStatCalculator<AstarWalletStats, AstarTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<AstarExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<AstarExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public AstarStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<AstarExplorerAccountNormalTransaction> transactions,
            IEnumerable<AstarExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public AstarWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToAstr() : 0),
                BalanceChangeInLastMonth = IStatCalculator<AstarTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<AstarTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
