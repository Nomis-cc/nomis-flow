...
namespace Nomis.AstarExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Astar Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddAstarExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<AstarExplorerSettings>(configuration);
            return services
                .AddTransient<IAstarExplorerClient, AstarExplorerClient>()
                .AddTransientInfrastructureService<IAstarScoringService, AstarExplorerService>();
        }
    }
}