// ------------------------------------------------------------------------------------------------------
// <copyright file="AuroraHelpers.cs" company="Nomis">
...
namespace Nomis.Aurorascan.Interfaces.Extensions
{
    /// <summary>
    /// Extension methods for Aurora.
    /// </summary>
    public static class AuroraHelpers
    {
        /// <summary>
        ...
        public static string GetTokenUid(this IAurorascanAccountNftTokenEvent token)
        {
