// ------------------------------------------------------------------------------------------------------
// <copyright file="IAurorascanClient.cs" company="Nomis">
...
namespace Nomis.Aurorascan.Interfaces
{
    ...
    /// Aurorascan client.
    /// </summary>
    public interface IAurorascanClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="AurorascanAccount"/>.</returns>
        Task<AurorascanAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="AurorascanAccount"/>.</returns>
        Task<AurorascanAccount> GetTokenBalanceAsync(string address, string contractAddress);
