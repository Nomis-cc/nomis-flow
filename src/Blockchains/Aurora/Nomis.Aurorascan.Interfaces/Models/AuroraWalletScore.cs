// ------------------------------------------------------------------------------------------------------
// <copyright file="AuroraWalletScore.cs" company="Nomis">
...
namespace Nomis.Aurorascan.Interfaces.Models
{
    ...
    /// Aurora wallet score.
    /// </summary>
    public class AuroraWalletScore :
        IWalletScore<AuroraWalletStats, AuroraTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public AuroraWalletStats? Stats { get; set; }
    }
}