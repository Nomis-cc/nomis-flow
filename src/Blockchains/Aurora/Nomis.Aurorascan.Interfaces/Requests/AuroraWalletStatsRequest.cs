// ------------------------------------------------------------------------------------------------------
// <copyright file="AuroraWalletStatsRequest.cs" company="Nomis">
...
namespace Nomis.Aurorascan.Interfaces.Requests
{
    /// <summary>
    /// Request for getting the wallet stats for Aurora.
    /// </summary>
    public sealed class AuroraWalletStatsRequest :
