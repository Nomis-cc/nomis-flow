// ------------------------------------------------------------------------------------------------------
// <copyright file="AuroraStatCalculator.cs" company="Nomis">
...
namespace Nomis.Aurorascan.Calculators
{
    /// <summary>
    /// Aurora wallet stats calculator.
    /// </summary>
    internal sealed class AuroraStatCalculator :
        IStatCalculator<AuroraWalletStats, AuroraTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<AurorascanAccountNormalTransaction> _transactions;
        private readonly IEnumerable<AurorascanAccountInternalTransaction> _internalTransactions;
        private readonly IEnumerable<IAurorascanAccountNftTokenEvent> _tokenTransfers;
        private readonly IEnumerable<AurorascanAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public AuroraStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<AurorascanAccountNormalTransaction> transactions,
            IEnumerable<AurorascanAccountInternalTransaction> internalTransactions,
            IEnumerable<IAurorascanAccountNftTokenEvent> tokenTransfers,
            IEnumerable<AurorascanAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public AuroraWalletStats GetStats()
        {
            ...
            var turnoverIntervals = IStatCalculator<AuroraTransactionIntervalData>
            ...
            return new()
            {
                ...
                BalanceChangeInLastMonth = IStatCalculator<AuroraTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<AuroraTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
