...
namespace Nomis.Aurorascan.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Aurorascan service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddAurorascanService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<AurorascanSettings>(configuration);
            return services
                .AddTransient<IAurorascanClient, AurorascanClient>()
                .AddTransientInfrastructureService<IAuroraScoringService, AurorascanService>();
        }
    }
}