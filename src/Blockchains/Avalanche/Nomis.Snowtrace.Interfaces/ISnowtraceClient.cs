...
namespace Nomis.Snowtrace.Interfaces
{
    ...
    public interface ISnowtraceClient
    {
        ...
        /// <returns>Returns <see cref="SnowtraceAccount"/>.</returns>
        Task<SnowtraceAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="SnowtraceAccount"/>.</returns>
        Task<SnowtraceAccount> GetTokenBalanceAsync(string address, string contractAddress);
