...
namespace Nomis.Snowtrace.Calculators
{
    ...
    internal sealed class AvalancheStatCalculator :
        IStatCalculator<AvalancheWalletStats, AvalancheTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<SnowtraceAccountNormalTransaction> _transactions;
        private readonly IEnumerable<SnowtraceAccountInternalTransaction> _internalTransactions;
        private readonly IEnumerable<ISnowtraceAccountNftTokenEvent> _tokenTransfers;
        private readonly IEnumerable<SnowtraceAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public AvalancheStatCalculator(
            ...
            decimal balance,
            decimal usdBalance,
            IEnumerable<SnowtraceAccountNormalTransaction> transactions,
            IEnumerable<SnowtraceAccountInternalTransaction> internalTransactions,
            IEnumerable<ISnowtraceAccountNftTokenEvent> tokenTransfers,
            IEnumerable<SnowtraceAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public AvalancheWalletStats GetStats()
        {
            ...
            var turnoverIntervals = IStatCalculator<AvalancheTransactionIntervalData>
                .GetTurnoverIntervals(turnoverIntervalsDataList, _transactions.Min(x => x.TimeStamp!.ToDateTime())).ToList();

            return new()
            {
                NativeBalance = _balance.ToAvax(),
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToAvax() : 0),
                BalanceChangeInLastMonth = IStatCalculator<AvalancheTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<AvalancheTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
                ...
                NftTrading = (soldSum - buySum).ToAvax(),
                NftWorth = nftWorth.ToAvax(),
