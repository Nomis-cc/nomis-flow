// ------------------------------------------------------------------------------------------------------
// <copyright file="BitTorrentWalletScore.cs" company="Nomis">
...
{
    /// <summary>
    /// BitTorrent wallet score.
    /// </summary>
    public class BitTorrentWalletScore :
        IWalletScore<BitTorrentWalletStats, BitTorrentTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public BitTorrentWalletStats? Stats { get; set; }
    }
}