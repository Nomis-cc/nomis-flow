...
namespace Nomis.Bttcscan.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Bttcscan service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddBttcscanService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<BttcscanSettings>(configuration);
            return services
                .AddTransient<IBttcscanClient, BttcscanClient>()
                .AddTransientInfrastructureService<IBitTorrentScoringService, BttcscanService>();
        }
    }
}