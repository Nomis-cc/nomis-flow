// ------------------------------------------------------------------------------------------------------
// <copyright file="BobaWalletScore.cs" company="Nomis">
...
namespace Nomis.Bobascan.Interfaces.Models
{
    ...
    /// Boba wallet score.
    /// </summary>
    public class BobaWalletScore :
        IWalletScore<BobaWalletStats, BobaTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public BobaWalletStats? Stats { get; set; }
    }
}