// ------------------------------------------------------------------------------------------------------
// <copyright file="BobaStatCalculator.cs" company="Nomis">
...
namespace Nomis.Bobascan.Calculators
{
    /// <summary>
    /// Boba wallet stats calculator.
    /// </summary>
    internal sealed class BobaStatCalculator :
        IStatCalculator<BobaWalletStats, BobaTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<BobascanAccountNormalTransaction> _transactions;
        private readonly IEnumerable<BobascanAccountInternalTransaction> _internalTransactions;
        private readonly IEnumerable<IBobascanAccountNftTokenEvent> _tokenTransfers;
        private readonly IEnumerable<BobascanAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public BobaStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<BobascanAccountNormalTransaction> transactions,
            IEnumerable<BobascanAccountInternalTransaction> internalTransactions,
            IEnumerable<IBobascanAccountNftTokenEvent> tokenTransfers,
            IEnumerable<BobascanAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public BobaWalletStats GetStats()
        {
            ...
            var turnoverIntervals = IStatCalculator<BobaTransactionIntervalData>
            ...
            return new()
            {
                ...
                BalanceChangeInLastMonth = IStatCalculator<BobaTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<BobaTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
