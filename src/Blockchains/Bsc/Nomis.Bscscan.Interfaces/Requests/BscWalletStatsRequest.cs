// ------------------------------------------------------------------------------------------------------
// <copyright file="BscWalletStatsRequest.cs" company="Nomis">
...
namespace Nomis.Bscscan.Interfaces.Requests
{
    /// <summary>
    /// Request for getting the wallet stats for BSC.
    /// </summary>
    public sealed class BscWalletStatsRequest :
