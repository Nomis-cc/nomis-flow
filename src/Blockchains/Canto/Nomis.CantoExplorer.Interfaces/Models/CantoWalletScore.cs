// ------------------------------------------------------------------------------------------------------
// <copyright file="CantoWalletScore.cs" company="Nomis">
...
namespace Nomis.CantoExplorer.Interfaces.Models
{
    ...
    /// Canto wallet score.
    /// </summary>
    public class CantoWalletScore :
        IWalletScore<CantoWalletStats, CantoTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public CantoWalletStats? Stats { get; set; }
    }
}