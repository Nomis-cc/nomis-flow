// ------------------------------------------------------------------------------------------------------
// <copyright file="CeloWalletTokenScore.cs" company="Nomis">
...
{
    /// <summary>
    /// Celo wallet token score.
    /// </summary>
    public class CeloWalletTokenScore :
        IWalletScore<CeloWalletTokenStats, CeloTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public CeloWalletTokenStats? Stats { get; set; }
    }
}