        ...
        IStatCalculator<CeloWalletStats, CeloTransactionIntervalData>
    {
        ...
        public CeloWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToCelo() : 0),
        ...
        public CeloWalletTokenStats GetTokenStats(string tokenName, decimal multiplier)
        {
