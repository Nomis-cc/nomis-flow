// ------------------------------------------------------------------------------------------------------
// <copyright file="CloudwalkWalletScore.cs" company="Nomis">
...
{
    /// <summary>
    /// Cloudwalk wallet score.
    /// </summary>
    public class CloudwalkWalletScore :
        IWalletScore<CloudwalkWalletStats, CloudwalkTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public CloudwalkWalletStats? Stats { get; set; }
    }
}