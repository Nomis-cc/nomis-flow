...
namespace Nomis.CloudwalkExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Cloudwalk Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddCloudwalkExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<CloudwalkExplorerSettings>(configuration);
            return services
                .AddTransient<ICloudwalkExplorerClient, CloudwalkExplorerClient>()
                .AddTransientInfrastructureService<ICloudwalkScoringService, CloudwalkExplorerService>();
        }
    }
}