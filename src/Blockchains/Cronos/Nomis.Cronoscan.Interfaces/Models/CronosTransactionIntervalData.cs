// ------------------------------------------------------------------------------------------------------
// <copyright file="CronosTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.Cronoscan.Interfaces.Models
{
    ...
    public class CronosTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToCro();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToCro();
        ...
        public decimal AmountInSumValue => AmountInSum.ToCro();
