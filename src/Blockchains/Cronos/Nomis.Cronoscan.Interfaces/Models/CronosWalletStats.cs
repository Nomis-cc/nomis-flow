// ------------------------------------------------------------------------------------------------------
// <copyright file="CronosWalletStats.cs" company="Nomis">
...
namespace Nomis.Cronoscan.Interfaces.Models
{
    ...
    /// Cronos wallet stats.
    /// </summary>
    public sealed class CronosWalletStats :
        BaseEvmWalletStats<CronosTransactionIntervalData>,
        IWalletDexTokenSwapPairsStats,
        IWalletNftStats
    {
        /// <inheritdoc/>
        public override string NativeToken => "CRO";
