// ------------------------------------------------------------------------------------------------------
// <copyright file="CronosWalletStatsRequest.cs" company="Nomis">
...
namespace Nomis.Cronoscan.Interfaces.Requests
{
    /// <summary>
    /// Request for getting the wallet stats for Cronos.
    /// </summary>
    public sealed class CronosWalletStatsRequest :
