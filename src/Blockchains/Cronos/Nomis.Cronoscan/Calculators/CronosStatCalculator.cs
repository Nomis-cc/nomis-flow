// ------------------------------------------------------------------------------------------------------
// <copyright file="CronosStatCalculator.cs" company="Nomis">
...
namespace Nomis.Cronoscan.Calculators
{
    /// <summary>
    /// Cronos wallet stats calculator.
    /// </summary>
    internal sealed class CronosStatCalculator :
        IStatCalculator<CronosWalletStats, CronosTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<CronoscanAccountNormalTransaction> _transactions;
        private readonly IEnumerable<CronoscanAccountInternalTransaction> _internalTransactions;
        private readonly IEnumerable<ICronoscanAccountNftTokenEvent> _tokenTransfers;
        private readonly IEnumerable<CronoscanAccountCRC20TokenEvent> _crc20TokenTransfers;
        ...
        public CronosStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<CronoscanAccountNormalTransaction> transactions,
            IEnumerable<CronoscanAccountInternalTransaction> internalTransactions,
            IEnumerable<ICronoscanAccountNftTokenEvent> tokenTransfers,
            IEnumerable<CronoscanAccountCRC20TokenEvent> crc20TokenTransfers,
            ...
            IEnumerable<ChainanalysisReport>? chainanalysisReports)
        {
            ...
            _crc20TokenTransfers = crc20TokenTransfers;
        ...
        public CronosWalletStats GetStats()
        {
            ...
            var totalTokens = _crc20TokenTransfers.Select(x => x.TokenSymbol).Distinct();
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToCro() : 0),
                BalanceChangeInLastMonth = IStatCalculator<CronosTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<CronosTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
                ...
                NftTrading = (soldSum - buySum).ToCro(),
                NftWorth = nftWorth.ToCro(),
