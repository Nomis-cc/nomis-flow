// ------------------------------------------------------------------------------------------------------
// <copyright file="CubeTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.Cubescan.Interfaces.Models
{
    ...
    public class CubeTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToCube();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToCube();
        ...
        public decimal AmountInSumValue => AmountInSum.ToCube();
