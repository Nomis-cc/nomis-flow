// ------------------------------------------------------------------------------------------------------
// <copyright file="IDogechainExplorerClient.cs" company="Nomis">
...
{
    /// <summary>
    /// Dogechain Explorer client.
    /// </summary>
    public interface IDogechainExplorerClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="DogechainExplorerAccount"/>.</returns>
        Task<DogechainExplorerAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="DogechainExplorerAccount"/>.</returns>
        Task<DogechainExplorerAccount> GetTokenBalanceAsync(string address, string contractAddress);
