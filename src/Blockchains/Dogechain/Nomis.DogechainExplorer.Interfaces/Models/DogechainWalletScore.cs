// ------------------------------------------------------------------------------------------------------
// <copyright file="DogechainWalletScore.cs" company="Nomis">
...
{
    /// <summary>
    /// Dogechain wallet score.
    /// </summary>
    public class DogechainWalletScore :
        IWalletScore<DogechainWalletStats, DogechainTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public DogechainWalletStats? Stats { get; set; }
    }
}