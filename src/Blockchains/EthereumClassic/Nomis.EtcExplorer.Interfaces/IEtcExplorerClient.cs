// ------------------------------------------------------------------------------------------------------
// <copyright file="IEtcExplorerClient.cs" company="Nomis">
...
namespace Nomis.EtcExplorer.Interfaces
{
    ...
    /// ETC Explorer client.
    /// </summary>
    public interface IEtcExplorerClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="EtcExplorerAccount"/>.</returns>
        Task<EtcExplorerAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="EtcExplorerAccount"/>.</returns>
        Task<EtcExplorerAccount> GetTokenBalanceAsync(string address, string contractAddress);
