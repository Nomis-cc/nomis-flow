// ------------------------------------------------------------------------------------------------------
// <copyright file="EtcTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.EtcExplorer.Interfaces.Models
{
    ...
    public class EtcTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToEtc();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToEtc();
        ...
        public decimal AmountInSumValue => AmountInSum.ToEtc();
