// ------------------------------------------------------------------------------------------------------
// <copyright file="EtcWalletScore.cs" company="Nomis">
...
namespace Nomis.EtcExplorer.Interfaces.Models
{
    ...
    /// Etc wallet score.
    /// </summary>
    public class EtcWalletScore :
        IWalletScore<EtcWalletStats, EtcTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public EtcWalletStats? Stats { get; set; }
    }
}