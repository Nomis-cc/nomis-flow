// ------------------------------------------------------------------------------------------------------
// <copyright file="EtcStatCalculator.cs" company="Nomis">
...
namespace Nomis.EtcExplorer.Calculators
{
    /// <summary>
    /// ETC wallet stats calculator.
    /// </summary>
    internal sealed class EtcStatCalculator :
        IStatCalculator<EtcWalletStats, EtcTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<EtcExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<EtcExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public EtcStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<EtcExplorerAccountNormalTransaction> transactions,
            IEnumerable<EtcExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public EtcWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToEtc() : 0),
                BalanceChangeInLastMonth = IStatCalculator<EtcTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<EtcTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
