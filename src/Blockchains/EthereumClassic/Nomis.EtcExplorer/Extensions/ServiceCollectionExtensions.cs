...
namespace Nomis.EtcExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add ETC Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddEtcExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<EtcExplorerSettings>(configuration);
            return services
                .AddTransient<IEtcExplorerClient, EtcExplorerClient>()
                .AddTransientInfrastructureService<IEtcScoringService, EtcExplorerService>();
        }
    }
}