...
namespace Nomis.Ftmscan.Calculators
{
    ...
    internal sealed class FantomStatCalculator :
        IStatCalculator<FantomWalletStats, FantomTransactionIntervalData>
    {
        ...
        public FantomWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToFtm() : 0),
                BalanceChangeInLastMonth = IStatCalculator<FantomTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<FantomTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
