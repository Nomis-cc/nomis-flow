...
namespace Nomis.Ftmscan.Extensions
{
    /// <summary>
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        internal static IServiceCollection AddFtmscanService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<FtmscanSettings>(configuration);
            return services
                .AddTransient<IFtmscanClient, FtmscanClient>()
                .AddTransientInfrastructureService<IFantomScoringService, FtmscanService>();
        }
    }
}