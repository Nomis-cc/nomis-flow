// ------------------------------------------------------------------------------------------------------
// <copyright file="IFlareExplorerClient.cs" company="Nomis">
...
namespace Nomis.FlareExplorer.Interfaces
{
    /// <summary>
    /// Flare Explorer client.
    /// </summary>
    public interface IFlareExplorerClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="FlareExplorerAccount"/>.</returns>
        Task<FlareExplorerAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="FlareExplorerAccount"/>.</returns>
        Task<FlareExplorerAccount> GetTokenBalanceAsync(string address, string contractAddress);
