// ------------------------------------------------------------------------------------------------------
// <copyright file="FlareWalletScore.cs" company="Nomis">
...
namespace Nomis.FlareExplorer.Interfaces.Models
{
    ...
    /// Flare wallet score.
    /// </summary>
    public class FlareWalletScore :
        IWalletScore<FlareWalletStats, FlareTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public FlareWalletStats? Stats { get; set; }
    }
}