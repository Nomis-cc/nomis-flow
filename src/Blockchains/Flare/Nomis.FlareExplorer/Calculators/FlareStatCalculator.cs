// ------------------------------------------------------------------------------------------------------
// <copyright file="FlareStatCalculator.cs" company="Nomis">
...
namespace Nomis.FlareExplorer.Calculators
{
    /// <summary>
    /// Flare wallet stats calculator.
    /// </summary>
    internal sealed class FlareStatCalculator :
        IStatCalculator<FlareWalletStats, FlareTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<FlareExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<FlareExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public FlareStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<FlareExplorerAccountNormalTransaction> transactions,
            IEnumerable<FlareExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public FlareWalletStats GetStats()
        {
            ...
            var turnoverIntervals = IStatCalculator<FlareTransactionIntervalData>
            ...
            return new()
            {
                ...
                BalanceChangeInLastMonth = IStatCalculator<FlareTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<FlareTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
