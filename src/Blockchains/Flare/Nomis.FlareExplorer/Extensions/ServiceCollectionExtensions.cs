...
namespace Nomis.FlareExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Flare Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddFlareExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<FlareExplorerSettings>(configuration);
            return services
                .AddTransient<IFlareExplorerClient, FlareExplorerClient>()
                .AddTransientInfrastructureService<IFlareScoringService, FlareExplorerService>();
        }
    }
}