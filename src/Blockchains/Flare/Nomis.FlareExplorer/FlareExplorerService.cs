// ------------------------------------------------------------------------------------------------------
// <copyright file="FlareExplorerService.cs" company="Nomis">
...
using Nomis.FlareExplorer.Calculators;
using Nomis.FlareExplorer.Interfaces;
using Nomis.FlareExplorer.Interfaces.Extensions;
...
{
    /// <inheritdoc cref="IFlareScoringService"/>
    internal sealed class FlareExplorerService :
        BlockchainDescriptor,
        IFlareScoringService,
        ITransientService
    {
        private readonly IFlareExplorerClient _client;
        ...
        /// <summary>
        /// Initialize <see cref="FlareExplorerService"/>.
        /// </summary>
        /// <param name="settings"><see cref="FlareExplorerSettings"/>.</param>
        /// <param name="client"><see cref="IFlareExplorerClient"/>.</param>
        ...
        public FlareExplorerService(
            IOptions<FlareExplorerSettings> settings,
            IFlareExplorerClient client,
            ...
            where TTransactionIntervalData : class, ITransactionIntervalData
        {
            ...
            var transactions = (await _client.GetTransactionsAsync<FlareExplorerAccountNormalTransactions, FlareExplorerAccountNormalTransaction>(request.Address).ConfigureAwait(false)).ToList();
            await Task.Delay(100, cancellationToken).ConfigureAwait(false);
            var erc20Tokens = (await _client.GetTransactionsAsync<FlareExplorerAccountERC20TokenEvents, FlareExplorerAccountERC20TokenEvent>(request.Address).ConfigureAwait(false)).ToList();
            ...
            var walletStats = new FlareStatCalculator(
                    request.Address,
