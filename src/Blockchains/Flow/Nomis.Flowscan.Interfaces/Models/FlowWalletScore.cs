// ------------------------------------------------------------------------------------------------------
// <copyright file="FlowWalletScore.cs" company="Nomis">
...
namespace Nomis.Flowscan.Interfaces.Models
{
    ...
    /// Flow wallet score.
    /// </summary>
    public class FlowWalletScore :
        IWalletScore<FlowWalletStats, FlowTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public FlowWalletStats? Stats { get; set; }
    }
}