// ------------------------------------------------------------------------------------------------------
// <copyright file="IFuseExplorerClient.cs" company="Nomis">
...
namespace Nomis.FuseExplorer.Interfaces
{
    /// <summary>
    /// Fuse Explorer client.
    /// </summary>
    public interface IFuseExplorerClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="FuseExplorerAccount"/>.</returns>
        Task<FuseExplorerAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="FuseExplorerAccount"/>.</returns>
        Task<FuseExplorerAccount> GetTokenBalanceAsync(string address, string contractAddress);
