// ------------------------------------------------------------------------------------------------------
// <copyright file="FuseTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.FuseExplorer.Interfaces.Models
{
    ...
    public class FuseTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToFuse();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToFuse();
        ...
        public decimal AmountInSumValue => AmountInSum.ToFuse();
