// ------------------------------------------------------------------------------------------------------
// <copyright file="FuseWalletScore.cs" company="Nomis">
...
namespace Nomis.FuseExplorer.Interfaces.Models
{
    ...
    /// Fuse wallet score.
    /// </summary>
    public class FuseWalletScore :
        IWalletScore<FuseWalletStats, FuseTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public FuseWalletStats? Stats { get; set; }
    }
}