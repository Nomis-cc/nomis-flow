// ------------------------------------------------------------------------------------------------------
// <copyright file="FuseStatCalculator.cs" company="Nomis">
...
namespace Nomis.FuseExplorer.Calculators
{
    /// <summary>
    /// Fuse wallet stats calculator.
    /// </summary>
    internal sealed class FuseStatCalculator :
        IStatCalculator<FuseWalletStats, FuseTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<FuseExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<FuseExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public FuseStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<FuseExplorerAccountNormalTransaction> transactions,
            IEnumerable<FuseExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public FuseWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToFuse() : 0),
                BalanceChangeInLastMonth = IStatCalculator<FuseTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<FuseTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
