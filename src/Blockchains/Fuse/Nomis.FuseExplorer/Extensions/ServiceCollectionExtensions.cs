...
namespace Nomis.FuseExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Fuse Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddFuseExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<FuseExplorerSettings>(configuration);
            return services
                .AddTransient<IFuseExplorerClient, FuseExplorerClient>()
                .AddTransientInfrastructureService<IFuseScoringService, FuseExplorerService>();
        }
    }
}