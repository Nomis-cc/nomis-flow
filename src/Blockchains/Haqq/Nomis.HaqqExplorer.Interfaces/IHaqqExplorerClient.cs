// ------------------------------------------------------------------------------------------------------
// <copyright file="IHaqqExplorerClient.cs" company="Nomis">
...
namespace Nomis.HaqqExplorer.Interfaces
{
    /// <summary>
    /// HAQQ Explorer client.
    /// </summary>
    public interface IHaqqExplorerClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="HaqqExplorerAccount"/>.</returns>
        Task<HaqqExplorerAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="HaqqExplorerAccount"/>.</returns>
        Task<HaqqExplorerAccount> GetTokenBalanceAsync(string address, string contractAddress);
