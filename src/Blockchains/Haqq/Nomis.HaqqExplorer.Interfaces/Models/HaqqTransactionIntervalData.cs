// ------------------------------------------------------------------------------------------------------
// <copyright file="HaqqTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.HaqqExplorer.Interfaces.Models
{
    ...
    public class HaqqTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToIslm();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToIslm();
        ...
        public decimal AmountInSumValue => AmountInSum.ToIslm();
