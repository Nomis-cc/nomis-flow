// ------------------------------------------------------------------------------------------------------
// <copyright file="HaqqWalletScore.cs" company="Nomis">
...
namespace Nomis.HaqqExplorer.Interfaces.Models
{
    ...
    /// HAQQ wallet score.
    /// </summary>
    public class HaqqWalletScore :
        IWalletScore<HaqqWalletStats, HaqqTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public HaqqWalletStats? Stats { get; set; }
    }
}