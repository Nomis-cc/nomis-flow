// ------------------------------------------------------------------------------------------------------
// <copyright file="HaqqStatCalculator.cs" company="Nomis">
...
using Nomis.HaqqExplorer.Interfaces.Extensions;
using Nomis.HaqqExplorer.Interfaces.Models;
using Nomis.Snapshot.Interfaces.Models;
using Nomis.Utils.Extensions;

namespace Nomis.HaqqExplorer.Calculators
{
    /// <summary>
    /// Haqq wallet stats calculator.
    /// </summary>
    internal sealed class HaqqStatCalculator :
        IStatCalculator<HaqqWalletStats, HaqqTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<HaqqExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<HaqqExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public HaqqStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<HaqqExplorerAccountNormalTransaction> transactions,
            IEnumerable<HaqqExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public HaqqWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToIslm() : 0),
                BalanceChangeInLastMonth = IStatCalculator<HaqqTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<HaqqTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
