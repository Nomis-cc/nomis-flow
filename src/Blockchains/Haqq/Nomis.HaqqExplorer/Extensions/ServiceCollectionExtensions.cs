...
namespace Nomis.HaqqExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add HAQQ Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddHaqqExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<HaqqExplorerSettings>(configuration);
            return services
                .AddTransient<IHaqqExplorerClient, HaqqExplorerClient>()
                .AddTransientInfrastructureService<IHaqqScoringService, HaqqExplorerService>();
        }
    }
}