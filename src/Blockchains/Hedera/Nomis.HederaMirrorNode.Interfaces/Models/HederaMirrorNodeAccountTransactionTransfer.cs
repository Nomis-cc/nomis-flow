// ------------------------------------------------------------------------------------------------------
// <copyright file="HederaMirrorNodeAccountTransactionTransfer.cs" company="Nomis">
...
{
    /// <summary>
    /// Hedera Mirror Node account transaction transfer data.
    /// </summary>
    public class HederaMirrorNodeAccountTransactionTransfer
    {
        /// <summary>
