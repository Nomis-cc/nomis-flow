// ------------------------------------------------------------------------------------------------------
// <copyright file="HederaTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.HederaMirrorNode.Interfaces.Models
{
    ...
    public class HederaTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToHbars();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToHbars();
        ...
        public decimal AmountInSumValue => AmountInSum.ToHbars();
