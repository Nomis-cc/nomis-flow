// ------------------------------------------------------------------------------------------------------
// <copyright file="HederaWalletScore.cs" company="Nomis">
...
namespace Nomis.HederaMirrorNode.Interfaces.Models
{
    ...
    /// Hedera wallet score.
    /// </summary>
    public class HederaWalletScore :
        IWalletScore<HederaWalletStats, HederaTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public HederaWalletStats? Stats { get; set; }
    }
}