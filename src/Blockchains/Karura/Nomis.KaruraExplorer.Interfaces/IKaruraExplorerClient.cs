// ------------------------------------------------------------------------------------------------------
// <copyright file="IKaruraExplorerClient.cs" company="Nomis">
...
{
    /// <summary>
    /// Karura Explorer client.
    /// </summary>
    public interface IKaruraExplorerClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="KaruraExplorerAccount"/>.</returns>
        Task<KaruraExplorerAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="KaruraExplorerAccount"/>.</returns>
        Task<KaruraExplorerAccount> GetTokenBalanceAsync(string address, string contractAddress);
