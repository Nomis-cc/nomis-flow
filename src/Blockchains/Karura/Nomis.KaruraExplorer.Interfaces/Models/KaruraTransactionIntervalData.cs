// ------------------------------------------------------------------------------------------------------
// <copyright file="KaruraTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.KaruraExplorer.Interfaces.Models
{
    ...
    public class KaruraTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToKar();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToKar();
        ...
        public decimal AmountInSumValue => AmountInSum.ToKar();
