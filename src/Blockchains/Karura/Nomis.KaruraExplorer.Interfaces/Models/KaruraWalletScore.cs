// ------------------------------------------------------------------------------------------------------
// <copyright file="KaruraWalletScore.cs" company="Nomis">
...
namespace Nomis.KaruraExplorer.Interfaces.Models
{
    ...
    /// Karura wallet score.
    /// </summary>
    public class KaruraWalletScore :
        IWalletScore<KaruraWalletStats, KaruraTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public KaruraWalletStats? Stats { get; set; }
    }
}