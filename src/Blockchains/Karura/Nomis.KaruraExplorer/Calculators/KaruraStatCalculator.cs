// ------------------------------------------------------------------------------------------------------
// <copyright file="KaruraStatCalculator.cs" company="Nomis">
...
namespace Nomis.KaruraExplorer.Calculators
{
    /// <summary>
    /// Karura wallet stats calculator.
    /// </summary>
    internal sealed class KaruraStatCalculator :
        IStatCalculator<KaruraWalletStats, KaruraTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<KaruraExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<KaruraExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public KaruraStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<KaruraExplorerAccountNormalTransaction> transactions,
            IEnumerable<KaruraExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public KaruraWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToKar() : 0),
                BalanceChangeInLastMonth = IStatCalculator<KaruraTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<KaruraTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
