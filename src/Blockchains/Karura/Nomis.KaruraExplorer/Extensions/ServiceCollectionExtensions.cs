...
namespace Nomis.KaruraExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Karura Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddKaruraExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<KaruraExplorerSettings>(configuration);
            return services
                .AddTransient<IKaruraExplorerClient, KaruraExplorerClient>()
                .AddTransientInfrastructureService<IKaruraScoringService, KaruraExplorerService>();
        }
    }
}