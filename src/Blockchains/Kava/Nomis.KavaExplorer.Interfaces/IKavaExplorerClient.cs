// ------------------------------------------------------------------------------------------------------
// <copyright file="IKavaExplorerClient.cs" company="Nomis">
...
{
    /// <summary>
    /// Kava Explorer client.
    /// </summary>
    public interface IKavaExplorerClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="KavaExplorerAccount"/>.</returns>
        Task<KavaExplorerAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="KavaExplorerAccount"/>.</returns>
        Task<KavaExplorerAccount> GetTokenBalanceAsync(string address, string contractAddress);
