// ------------------------------------------------------------------------------------------------------
// <copyright file="KavaTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.KavaExplorer.Interfaces.Models
{
    ...
    public class KavaTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToKava();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToKava();
        ...
        public decimal AmountInSumValue => AmountInSum.ToKava();
