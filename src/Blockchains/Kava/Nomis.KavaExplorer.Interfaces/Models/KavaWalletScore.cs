// ------------------------------------------------------------------------------------------------------
// <copyright file="KavaWalletScore.cs" company="Nomis">
...
namespace Nomis.KavaExplorer.Interfaces.Models
{
    ...
    /// Kava wallet score.
    /// </summary>
    public class KavaWalletScore :
        IWalletScore<KavaWalletStats, KavaTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public KavaWalletStats? Stats { get; set; }
    }
}