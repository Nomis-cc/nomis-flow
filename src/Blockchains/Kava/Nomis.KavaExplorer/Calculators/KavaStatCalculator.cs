// ------------------------------------------------------------------------------------------------------
// <copyright file="KavaStatCalculator.cs" company="Nomis">
...
namespace Nomis.KavaExplorer.Calculators
{
    /// <summary>
    /// Kava wallet stats calculator.
    /// </summary>
    internal sealed class KavaStatCalculator :
        IStatCalculator<KavaWalletStats, KavaTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<KavaExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<KavaExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public KavaStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<KavaExplorerAccountNormalTransaction> transactions,
            IEnumerable<KavaExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public KavaWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToKava() : 0),
                BalanceChangeInLastMonth = IStatCalculator<KavaTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<KavaTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
