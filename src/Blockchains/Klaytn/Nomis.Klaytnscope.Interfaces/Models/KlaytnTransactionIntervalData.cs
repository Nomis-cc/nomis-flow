// ------------------------------------------------------------------------------------------------------
// <copyright file="KlaytnTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.Klaytnscope.Interfaces.Models
{
    ...
    public class KlaytnTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToKlay();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToKlay();
        ...
        public decimal AmountInSumValue => AmountInSum.ToKlay();
