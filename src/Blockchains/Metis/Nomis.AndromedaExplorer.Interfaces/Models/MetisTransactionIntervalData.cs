// ------------------------------------------------------------------------------------------------------
// <copyright file="MetisTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.AndromedaExplorer.Interfaces.Models
{
    ...
    public class MetisTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToMetis();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToMetis();
        ...
        public decimal AmountInSumValue => AmountInSum.ToMetis();
