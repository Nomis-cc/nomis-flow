...
namespace Nomis.AndromedaExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Andromeda Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddAndromedaExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<AndromedaExplorerSettings>(configuration);
            return services
                .AddTransient<IAndromedaExplorerClient, AndromedaExplorerClient>()
                .AddTransientInfrastructureService<IMetisScoringService, AndromedaExplorerService>();
        }
    }
}