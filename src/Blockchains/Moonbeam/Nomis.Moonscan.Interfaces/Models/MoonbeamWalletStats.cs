// ------------------------------------------------------------------------------------------------------
// <copyright file="MoonbeamWalletStats.cs" company="Nomis">
...
namespace Nomis.Moonscan.Interfaces.Models
{
    ...
    /// </summary>
    public sealed class MoonbeamWalletStats :
        BaseEvmWalletStats<MoonbeamTransactionIntervalData>,
        IWalletDexTokenSwapPairsStats,
        IWalletNftStats
    {
        /// <inheritdoc/>
        public override string NativeToken => "GLMR";
