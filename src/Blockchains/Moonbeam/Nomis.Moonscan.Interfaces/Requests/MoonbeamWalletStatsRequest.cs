// ------------------------------------------------------------------------------------------------------
// <copyright file="MoonbeamWalletStatsRequest.cs" company="Nomis">
...
namespace Nomis.Moonscan.Interfaces.Requests
{
    /// <summary>
    /// Request for getting the wallet stats for Moonbeam.
    /// </summary>
    public sealed class MoonbeamWalletStatsRequest :
