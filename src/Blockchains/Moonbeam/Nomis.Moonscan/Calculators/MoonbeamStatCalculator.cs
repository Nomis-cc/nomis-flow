// ------------------------------------------------------------------------------------------------------
// <copyright file="MoonbeamStatCalculator.cs" company="Nomis">
...
namespace Nomis.Moonscan.Calculators
{
    ...
    internal sealed class MoonbeamStatCalculator :
        IStatCalculator<MoonbeamWalletStats, MoonbeamTransactionIntervalData>
    {
        ...
        private readonly IEnumerable<MoonscanAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public MoonbeamStatCalculator(
            ...
            IEnumerable<MoonscanAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public MoonbeamWalletStats GetStats()
        {
            ...
            var turnoverIntervals = IStatCalculator<MoonbeamTransactionIntervalData>
                .GetTurnoverIntervals(turnoverIntervalsDataList, _transactions.Min(x => x.TimeStamp!.ToDateTime())).ToList();

            return new()
            {
                NativeBalance = _balance.ToGlmr(),
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToGlmr() : 0),
                TurnoverIntervals = turnoverIntervals,
                BalanceChangeInLastMonth = IStatCalculator<MoonbeamTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<MoonbeamTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
