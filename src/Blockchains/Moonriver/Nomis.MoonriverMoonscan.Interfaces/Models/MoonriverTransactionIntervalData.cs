// ------------------------------------------------------------------------------------------------------
// <copyright file="MoonriverTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.MoonriverMoonscan.Interfaces.Models
{
    ...
    public class MoonriverTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToMovr();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToMovr();
        ...
        public decimal AmountInSumValue => AmountInSum.ToMovr();
