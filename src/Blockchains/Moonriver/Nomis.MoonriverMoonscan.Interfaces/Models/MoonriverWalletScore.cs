// ------------------------------------------------------------------------------------------------------
// <copyright file="MoonriverWalletScore.cs" company="Nomis">
...
{
    /// <summary>
    /// Moonriver wallet score.
    /// </summary>
    public class MoonriverWalletScore :
        IWalletScore<MoonriverWalletStats, MoonriverTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public MoonriverWalletStats? Stats { get; set; }
    }
}