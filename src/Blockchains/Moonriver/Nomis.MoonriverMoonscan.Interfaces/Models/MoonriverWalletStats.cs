// ------------------------------------------------------------------------------------------------------
// <copyright file="MoonriverWalletStats.cs" company="Nomis">
...
{
    /// <summary>
    /// Moonriver wallet stats.
    /// </summary>
    public sealed class MoonriverWalletStats :
        BaseEvmWalletStats<MoonriverTransactionIntervalData>,
        IWalletDexTokenSwapPairsStats,
        IWalletNftStats
    {
        /// <inheritdoc/>
        public override string NativeToken => "MOVR";
