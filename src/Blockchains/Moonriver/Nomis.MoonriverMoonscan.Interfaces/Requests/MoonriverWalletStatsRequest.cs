// ------------------------------------------------------------------------------------------------------
// <copyright file="MoonriverWalletStatsRequest.cs" company="Nomis">
...
namespace Nomis.MoonriverMoonscan.Interfaces.Requests
{
    /// <summary>
    /// Request for getting the wallet stats for Moonriver.
    /// </summary>
    public sealed class MoonriverWalletStatsRequest :
