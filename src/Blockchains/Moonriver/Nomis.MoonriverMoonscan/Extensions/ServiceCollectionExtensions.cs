...
namespace Nomis.MoonriverMoonscan.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Moonriver moonscan service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddMoonriverMoonscanService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<MoonriverMoonscanSettings>(configuration);
            return services
                .AddTransient<IMoonriverMoonscanClient, MoonriverMoonscanClient>()
                .AddTransientInfrastructureService<IMoonriverScoringService, MoonriverMoonscanService>();
        }
    }
}