// ------------------------------------------------------------------------------------------------------
// <copyright file="NearTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.Nearblocks.Interfaces.Models
{
    ...
    public class NearTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToNear();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToNear();
        ...
        public decimal AmountInSumValue => AmountInSum.ToNear();
