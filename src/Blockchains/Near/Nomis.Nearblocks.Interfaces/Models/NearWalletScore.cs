// ------------------------------------------------------------------------------------------------------
// <copyright file="NearWalletScore.cs" company="Nomis">
...
namespace Nomis.Nearblocks.Interfaces.Models
{
    ...
    /// Near wallet score.
    /// </summary>
    public class NearWalletScore :
        IWalletScore<NearWalletStats, NearTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public NearWalletStats? Stats { get; set; }
    }
}