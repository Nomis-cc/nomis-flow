...
namespace Nomis.Nearblocks.Interfaces.Models
{
    ...
    /// Near wallet stats.
    /// </summary>
    public sealed class NearWalletStats :
        IWalletCommonStats<NearTransactionIntervalData>,
        ...
        IWalletHapiStats
    {
        ...
        /// <inheritdoc/>
        public string NativeToken => "Near";
        ...
        /// <inheritdoc/>
        public IEnumerable<NearTransactionIntervalData>? TurnoverIntervals { get; init; }
        ...
        public IEnumerable<string> ExcludedStatDescriptions =>
            IWalletCommonStats<NearTransactionIntervalData>.ExcludedStatDescriptions.Union(new List<string>
            {
