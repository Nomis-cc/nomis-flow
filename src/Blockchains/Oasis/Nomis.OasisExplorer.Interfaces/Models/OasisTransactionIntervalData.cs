// ------------------------------------------------------------------------------------------------------
// <copyright file="OasisTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.OasisExplorer.Interfaces.Models
{
    ...
    public class OasisTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToRose();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToRose();
        ...
        public decimal AmountInSumValue => AmountInSum.ToRose();
