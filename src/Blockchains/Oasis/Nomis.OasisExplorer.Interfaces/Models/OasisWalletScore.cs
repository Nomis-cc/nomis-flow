// ------------------------------------------------------------------------------------------------------
// <copyright file="OasisWalletScore.cs" company="Nomis">
...
namespace Nomis.OasisExplorer.Interfaces.Models
{
    ...
    /// Oasis wallet score.
    /// </summary>
    public class OasisWalletScore :
        IWalletScore<OasisWalletStats, OasisTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public OasisWalletStats? Stats { get; set; }
    }
}