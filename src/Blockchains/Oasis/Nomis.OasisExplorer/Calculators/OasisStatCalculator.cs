// ------------------------------------------------------------------------------------------------------
// <copyright file="OasisStatCalculator.cs" company="Nomis">
...
namespace Nomis.OasisExplorer.Calculators
{
    /// <summary>
    /// Oasis wallet stats calculator.
    /// </summary>
    internal sealed class OasisStatCalculator :
        IStatCalculator<OasisWalletStats, OasisTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<OasisExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<OasisExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public OasisStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<OasisExplorerAccountNormalTransaction> transactions,
            IEnumerable<OasisExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public OasisWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToRose() : 0),
                BalanceChangeInLastMonth = IStatCalculator<OasisTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<OasisTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
