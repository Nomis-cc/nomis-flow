// ------------------------------------------------------------------------------------------------------
// <copyright file="IOptimismClient.cs" company="Nomis">
...
namespace Nomis.Optimism.Interfaces
{
    ...
    /// Optimism client.
    /// </summary>
    public interface IOptimismClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="OptimismAccount"/>.</returns>
        Task<OptimismAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="OptimismAccount"/>.</returns>
        Task<OptimismAccount> GetTokenBalanceAsync(string address, string contractAddress);
