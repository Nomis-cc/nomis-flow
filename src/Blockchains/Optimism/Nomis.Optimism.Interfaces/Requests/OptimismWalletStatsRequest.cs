// ------------------------------------------------------------------------------------------------------
// <copyright file="OptimismWalletStatsRequest.cs" company="Nomis">
...
namespace Nomis.Optimism.Interfaces.Requests
{
    /// <summary>
    /// Request for getting the wallet stats for Optimism.
    /// </summary>
    public sealed class OptimismWalletStatsRequest :
