...
namespace Nomis.Optimism.Calculators
{
    ...
    internal sealed class OptimismStatCalculator :
        IStatCalculator<OptimismWalletStats, OptimismTransactionIntervalData>
    {
        ...
        public OptimismWalletStats GetStats()
        {
            ...
            var turnoverIntervals = IStatCalculator<OptimismTransactionIntervalData>
            ...
            return new()
            {
                ...
                BalanceChangeInLastMonth = IStatCalculator<OptimismTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<OptimismTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
