...
namespace Nomis.Optimism.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Optimism service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddOptimismService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<OptimismSettings>(configuration);
            return services
                .AddTransient<IOptimismClient, OptimismClient>()
                .AddTransientInfrastructureService<IOptimismScoringService, OptimismService>();
        }
    }
}