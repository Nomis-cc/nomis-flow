// ------------------------------------------------------------------------------------------------------
// <copyright file="IPoaExplorerClient.cs" company="Nomis">
...
namespace Nomis.PoaExplorer.Interfaces
{
    /// <summary>
    /// POA Explorer client.
    /// </summary>
    public interface IPoaExplorerClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="PoaExplorerAccount"/>.</returns>
        Task<PoaExplorerAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="PoaExplorerAccount"/>.</returns>
        Task<PoaExplorerAccount> GetTokenBalanceAsync(string address, string contractAddress);
