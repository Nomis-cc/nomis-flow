// ------------------------------------------------------------------------------------------------------
// <copyright file="PoaTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.PoaExplorer.Interfaces.Models
{
    ...
    public class PoaTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToPoa();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToPoa();
        ...
        public decimal AmountInSumValue => AmountInSum.ToPoa();
