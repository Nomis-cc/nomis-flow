// ------------------------------------------------------------------------------------------------------
// <copyright file="PoaWalletScore.cs" company="Nomis">
...
namespace Nomis.PoaExplorer.Interfaces.Models
{
    ...
    /// POA wallet score.
    /// </summary>
    public class PoaWalletScore :
        IWalletScore<PoaWalletStats, PoaTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public PoaWalletStats? Stats { get; set; }
    }
}