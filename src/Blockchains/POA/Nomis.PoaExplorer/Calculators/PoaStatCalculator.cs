// ------------------------------------------------------------------------------------------------------
// <copyright file="PoaStatCalculator.cs" company="Nomis">
...
namespace Nomis.PoaExplorer.Calculators
{
    /// <summary>
    /// Poa wallet stats calculator.
    /// </summary>
    internal sealed class PoaStatCalculator :
        IStatCalculator<PoaWalletStats, PoaTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<PoaExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<PoaExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public PoaStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<PoaExplorerAccountNormalTransaction> transactions,
            IEnumerable<PoaExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public PoaWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToPoa() : 0),
                BalanceChangeInLastMonth = IStatCalculator<PoaTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<PoaTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
