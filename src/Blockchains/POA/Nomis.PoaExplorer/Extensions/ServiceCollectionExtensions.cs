...
namespace Nomis.PoaExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add POA Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddPoaExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<PoaExplorerSettings>(configuration);
            return services
                .AddTransient<IPoaExplorerClient, PoaExplorerClient>()
                .AddTransientInfrastructureService<IPoaScoringService, PoaExplorerService>();
        }
    }
}