// ------------------------------------------------------------------------------------------------------
// <copyright file="PolygonWalletStatsRequest.cs" company="Nomis">
...
namespace Nomis.Polygonscan.Interfaces.Requests
{
    /// <summary>
    /// Request for getting the wallet stats for Polygon.
    /// </summary>
    public sealed class PolygonWalletStatsRequest :
