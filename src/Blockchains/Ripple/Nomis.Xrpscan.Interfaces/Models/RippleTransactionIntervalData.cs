// ------------------------------------------------------------------------------------------------------
// <copyright file="RippleTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.Xrpscan.Interfaces.Models
{
    ...
    public class RippleTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToXrp();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToXrp();
        ...
        public decimal AmountInSumValue => AmountInSum.ToXrp();
