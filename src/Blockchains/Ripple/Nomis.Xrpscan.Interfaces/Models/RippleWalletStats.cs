...
namespace Nomis.Xrpscan.Interfaces.Models
{
    ...
    /// Ripple wallet stats.
    /// </summary>
    public sealed class RippleWalletStats :
        IWalletCommonStats<RippleTransactionIntervalData>,
        ...
        IWalletGreysafeStats
    {
        ...
        /// <inheritdoc/>
        public IEnumerable<RippleTransactionIntervalData>? TurnoverIntervals { get; init; } =
            new List<RippleTransactionIntervalData>();
        ...
        public IEnumerable<string> ExcludedStatDescriptions =>
            IWalletCommonStats<RippleTransactionIntervalData>.ExcludedStatDescriptions.Union(new List<string>
            {
