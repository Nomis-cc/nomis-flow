// ------------------------------------------------------------------------------------------------------
// <copyright file="RskTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.RskExplorer.Interfaces.Models
{
    ...
    public class RskTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToRbtc();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToRbtc();
        ...
        public decimal AmountInSumValue => AmountInSum.ToRbtc();
