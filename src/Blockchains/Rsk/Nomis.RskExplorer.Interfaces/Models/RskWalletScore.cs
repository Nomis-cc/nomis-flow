// ------------------------------------------------------------------------------------------------------
// <copyright file="RskWalletScore.cs" company="Nomis">
...
namespace Nomis.RskExplorer.Interfaces.Models
{
    ...
    /// RSK wallet score.
    /// </summary>
    public class RskWalletScore :
        IWalletScore<RskWalletStats, RskTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public RskWalletStats? Stats { get; set; }
    }
}