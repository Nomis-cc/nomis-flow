// ------------------------------------------------------------------------------------------------------
// <copyright file="RskStatCalculator.cs" company="Nomis">
...
namespace Nomis.RskExplorer.Calculators
{
    /// <summary>
    /// Rsk wallet stats calculator.
    /// </summary>
    internal sealed class RskStatCalculator :
        IStatCalculator<RskWalletStats, RskTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<RskExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<RskExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public RskStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<RskExplorerAccountNormalTransaction> transactions,
            IEnumerable<RskExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public RskWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToRbtc() : 0),
                BalanceChangeInLastMonth = IStatCalculator<RskTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<RskTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
