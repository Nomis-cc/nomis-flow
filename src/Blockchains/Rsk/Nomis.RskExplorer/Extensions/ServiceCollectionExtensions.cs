...
namespace Nomis.RskExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add RSK Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddRskExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<RskExplorerSettings>(configuration);
            return services
                .AddTransient<IRskExplorerClient, RskExplorerClient>()
                .AddTransientInfrastructureService<IRskScoringService, RskExplorerService>();
        }
    }
}