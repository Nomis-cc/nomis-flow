// ------------------------------------------------------------------------------------------------------
// <copyright file="IScrollScanClient.cs" company="Nomis">
...
namespace Nomis.ScrollScan.Interfaces
{
    ...
    /// ScrollScan client.
    /// </summary>
    public interface IScrollScanClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="ScrollScanAccount"/>.</returns>
        Task<ScrollScanAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="ScrollScanAccount"/>.</returns>
        Task<ScrollScanAccount> GetTokenBalanceAsync(string address, string contractAddress);
