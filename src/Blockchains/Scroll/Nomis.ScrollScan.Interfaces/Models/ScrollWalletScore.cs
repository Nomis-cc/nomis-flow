// ------------------------------------------------------------------------------------------------------
// <copyright file="ScrollWalletScore.cs" company="Nomis">
...
namespace Nomis.ScrollScan.Interfaces.Models
{
    ...
    /// Scroll wallet score.
    /// </summary>
    public class ScrollWalletScore :
        IWalletScore<ScrollWalletStats, ScrollTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public ScrollWalletStats? Stats { get; set; }
    }
}