// ------------------------------------------------------------------------------------------------------
// <copyright file="ScrollStatCalculator.cs" company="Nomis">
...
using Nomis.ScrollScan.Interfaces.Extensions;
using Nomis.ScrollScan.Interfaces.Models;
using Nomis.Snapshot.Interfaces.Models;
using Nomis.Utils.Extensions;

namespace Nomis.ScrollScan.Calculators
{
    /// <summary>
    /// Scroll wallet stats calculator.
    /// </summary>
    internal sealed class ScrollStatCalculator :
        IStatCalculator<ScrollWalletStats, ScrollTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<ScrollScanAccountNormalTransaction> _transactions;
        private readonly IEnumerable<ScrollScanAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public ScrollStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<ScrollScanAccountNormalTransaction> transactions,
            IEnumerable<ScrollScanAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public ScrollWalletStats GetStats()
        {
            ...
            var turnoverIntervals = IStatCalculator<ScrollTransactionIntervalData>
            ...
            return new()
            {
                ...
                BalanceChangeInLastMonth = IStatCalculator<ScrollTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<ScrollTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
