...
namespace Nomis.ScrollScan.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add ScrollScan service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddScrollScanService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<ScrollScanSettings>(configuration);
            return services
                .AddTransient<IScrollScanClient, ScrollScanClient>()
                .AddTransientInfrastructureService<IScrollScoringService, ScrollScanService>();
        }
    }
}