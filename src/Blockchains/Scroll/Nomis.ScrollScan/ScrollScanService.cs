// ------------------------------------------------------------------------------------------------------
// <copyright file="ScrollScanService.cs" company="Nomis">
...
using Nomis.ScrollScan.Calculators;
...
{
    /// <inheritdoc cref="IScrollScoringService"/>
    internal sealed class ScrollScanService :
        BlockchainDescriptor,
        IScrollScoringService,
        ITransientService
    {
        private readonly IScrollScanClient _client;
        ...
        /// <summary>
        /// Initialize <see cref="ScrollScanService"/>.
        /// </summary>
        /// <param name="settings"><see cref="ScrollScanSettings"/>.</param>
        /// <param name="client"><see cref="IScrollScanClient"/>.</param>
        ...
        public ScrollScanService(
            IOptions<ScrollScanSettings> settings,
            IScrollScanClient client,
            ...
            where TTransactionIntervalData : class, ITransactionIntervalData
        {
            ...
            var transactions = (await _client.GetTransactionsAsync<ScrollScanAccountNormalTransactions, ScrollScanAccountNormalTransaction>(request.Address).ConfigureAwait(false)).ToList();
            await Task.Delay(100, cancellationToken).ConfigureAwait(false);
            var erc20Tokens = (await _client.GetTransactionsAsync<ScrollScanAccountERC20TokenEvents, ScrollScanAccountERC20TokenEvent>(request.Address).ConfigureAwait(false)).ToList();
            ...
            var walletStats = new ScrollStatCalculator(
                    request.Address,
