// ------------------------------------------------------------------------------------------------------
// <copyright file="IShidenExplorerClient.cs" company="Nomis">
...
namespace Nomis.ShidenExplorer.Interfaces
{
    /// <summary>
    /// Shiden Explorer client.
    /// </summary>
    public interface IShidenExplorerClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="ShidenExplorerAccount"/>.</returns>
        Task<ShidenExplorerAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="ShidenExplorerAccount"/>.</returns>
        Task<ShidenExplorerAccount> GetTokenBalanceAsync(string address, string contractAddress);
