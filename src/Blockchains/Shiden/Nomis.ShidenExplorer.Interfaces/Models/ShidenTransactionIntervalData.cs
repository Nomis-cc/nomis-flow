// ------------------------------------------------------------------------------------------------------
// <copyright file="ShidenTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.ShidenExplorer.Interfaces.Models
{
    ...
    public class ShidenTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToSdn();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToSdn();
        ...
        public decimal AmountInSumValue => AmountInSum.ToSdn();
