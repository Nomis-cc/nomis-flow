// ------------------------------------------------------------------------------------------------------
// <copyright file="ShidenWalletScore.cs" company="Nomis">
...
namespace Nomis.ShidenExplorer.Interfaces.Models
{
    ...
    /// Shiden wallet score.
    /// </summary>
    public class ShidenWalletScore :
        IWalletScore<ShidenWalletStats, ShidenTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public ShidenWalletStats? Stats { get; set; }
    }
}