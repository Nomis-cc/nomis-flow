// ------------------------------------------------------------------------------------------------------
// <copyright file="ShidenStatCalculator.cs" company="Nomis">
...
namespace Nomis.ShidenExplorer.Calculators
{
    /// <summary>
    /// Shiden wallet stats calculator.
    /// </summary>
    internal sealed class ShidenStatCalculator :
        IStatCalculator<ShidenWalletStats, ShidenTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<ShidenExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<ShidenExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public ShidenStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<ShidenExplorerAccountNormalTransaction> transactions,
            IEnumerable<ShidenExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public ShidenWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToSdn() : 0),
                BalanceChangeInLastMonth = IStatCalculator<ShidenTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<ShidenTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
