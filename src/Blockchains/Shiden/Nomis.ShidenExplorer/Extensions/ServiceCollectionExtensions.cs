...
namespace Nomis.ShidenExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Shiden Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddShidenExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<ShidenExplorerSettings>(configuration);
            return services
                .AddTransient<IShidenExplorerClient, ShidenExplorerClient>()
                .AddTransientInfrastructureService<IShidenScoringService, ShidenExplorerService>();
        }
    }
}