// ------------------------------------------------------------------------------------------------------
// <copyright file="ISongbirdExplorerClient.cs" company="Nomis">
...
{
    /// <summary>
    /// Songbird Explorer client.
    /// </summary>
    public interface ISongbirdExplorerClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="SongbirdExplorerAccount"/>.</returns>
        Task<SongbirdExplorerAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="SongbirdExplorerAccount"/>.</returns>
        Task<SongbirdExplorerAccount> GetTokenBalanceAsync(string address, string contractAddress);
