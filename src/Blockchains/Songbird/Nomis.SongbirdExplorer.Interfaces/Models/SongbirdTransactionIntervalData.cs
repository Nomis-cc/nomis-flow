// ------------------------------------------------------------------------------------------------------
// <copyright file="SongbirdTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.SongbirdExplorer.Interfaces.Models
{
    ...
    public class SongbirdTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToSgb();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToSgb();
        ...
        public decimal AmountInSumValue => AmountInSum.ToSgb();
