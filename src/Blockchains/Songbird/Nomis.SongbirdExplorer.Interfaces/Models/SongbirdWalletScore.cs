// ------------------------------------------------------------------------------------------------------
// <copyright file="SongbirdWalletScore.cs" company="Nomis">
...
{
    /// <summary>
    /// Songbird wallet score.
    /// </summary>
    public class SongbirdWalletScore :
        IWalletScore<SongbirdWalletStats, SongbirdTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public SongbirdWalletStats? Stats { get; set; }
    }
}