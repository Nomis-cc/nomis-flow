...
namespace Nomis.SongbirdExplorer.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Add Songbird Explorer service.
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <returns>Returns <see cref="IServiceCollection"/>.</returns>
        internal static IServiceCollection AddSongbirdExplorerService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<SongbirdExplorerSettings>(configuration);
            return services
                .AddTransient<ISongbirdExplorerClient, SongbirdExplorerClient>()
                .AddTransientInfrastructureService<ISongbirdScoringService, SongbirdExplorerService>();
        }
    }
}