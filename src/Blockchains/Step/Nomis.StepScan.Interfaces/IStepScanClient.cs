// ------------------------------------------------------------------------------------------------------
// <copyright file="IStepScanClient.cs" company="Nomis">
...
namespace Nomis.StepScan.Interfaces
{
    ...
    /// StepScan client.
    /// </summary>
    public interface IStepScanClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="StepScanAccount"/>.</returns>
        Task<StepScanAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="StepScanAccount"/>.</returns>
        Task<StepScanAccount> GetTokenBalanceAsync(string address, string contractAddress);
