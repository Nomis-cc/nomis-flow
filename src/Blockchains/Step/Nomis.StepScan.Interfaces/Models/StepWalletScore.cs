// ------------------------------------------------------------------------------------------------------
// <copyright file="StepWalletScore.cs" company="Nomis">
...
namespace Nomis.StepScan.Interfaces.Models
{
    ...
    /// Step wallet score.
    /// </summary>
    public class StepWalletScore :
        IWalletScore<StepWalletStats, StepTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public StepWalletStats? Stats { get; set; }
    }
}