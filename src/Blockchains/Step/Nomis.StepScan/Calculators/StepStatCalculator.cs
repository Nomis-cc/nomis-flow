// ------------------------------------------------------------------------------------------------------
// <copyright file="StepStatCalculator.cs" company="Nomis">
...
namespace Nomis.StepScan.Calculators
{
    /// <summary>
    /// Step wallet stats calculator.
    /// </summary>
    internal sealed class StepStatCalculator :
        IStatCalculator<StepWalletStats, StepTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<StepScanAccountNormalTransaction> _transactions;
        private readonly IEnumerable<StepScanAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public StepStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<StepScanAccountNormalTransaction> transactions,
            IEnumerable<StepScanAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public StepWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToFitfi() : 0),
                BalanceChangeInLastMonth = IStatCalculator<StepTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<StepTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
