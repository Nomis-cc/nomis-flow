// ------------------------------------------------------------------------------------------------------
// <copyright file="TonWalletScore.cs" company="Nomis">
...
namespace Nomis.Tonscan.Interfaces.Models
{
    ...
    /// TON wallet score.
    /// </summary>
    public class TonWalletScore :
        IWalletScore<TonWalletStats, TonTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public TonWalletStats? Stats { get; set; }
    }
}