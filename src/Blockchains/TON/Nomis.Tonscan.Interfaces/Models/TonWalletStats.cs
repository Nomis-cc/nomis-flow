// ------------------------------------------------------------------------------------------------------
// <copyright file="TonWalletStats.cs" company="Nomis">
...
namespace Nomis.Tonscan.Interfaces.Models
{
    ...
    /// TON wallet stats.
    /// </summary>
    public sealed class TonWalletStats :
        IWalletCommonStats<TonTransactionIntervalData>,
        ...
        IWalletTokenStats
    {
        ...
        /// <inheritdoc/>
        public IEnumerable<TonTransactionIntervalData>? TurnoverIntervals { get; init; }
        ...
        public IEnumerable<string> ExcludedStatDescriptions =>
            IWalletCommonStats<TonTransactionIntervalData>.ExcludedStatDescriptions.Union(new List<string>
            {
                nameof(TotalRejectedTransactions),
                nameof(NftTrading),
                nameof(NftWorth),
