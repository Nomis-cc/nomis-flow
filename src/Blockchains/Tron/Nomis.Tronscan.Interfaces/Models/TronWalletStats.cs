// ------------------------------------------------------------------------------------------------------
// <copyright file="TronWalletStats.cs" company="Nomis">
...
namespace Nomis.Tronscan.Interfaces.Models
{
    ...
    /// Tron wallet stats.
    /// </summary>
    public sealed class TronWalletStats :
        IWalletCommonStats<TronTransactionIntervalData>,
        ...
        IWalletGreysafeStats
    {
        ...
        /// <inheritdoc/>
        public IEnumerable<TronTransactionIntervalData>? TurnoverIntervals { get; init; }
        ...
        public IEnumerable<string> ExcludedStatDescriptions =>
            IWalletCommonStats<TronTransactionIntervalData>.ExcludedStatDescriptions.Union(new List<string>
            {
