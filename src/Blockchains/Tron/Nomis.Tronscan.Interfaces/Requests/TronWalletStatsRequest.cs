// ------------------------------------------------------------------------------------------------------
// <copyright file="TronWalletStatsRequest.cs" company="Nomis">
...
namespace Nomis.Tronscan.Interfaces.Requests
{
    /// <summary>
    /// Request for getting the wallet stats for Tron.
    /// </summary>
    public sealed class TronWalletStatsRequest :
        WalletStatsRequest,
