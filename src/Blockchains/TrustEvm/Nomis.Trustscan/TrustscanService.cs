...
namespace Nomis.Trustscan
{
        ...
        ITransientService
    {
        ...
        /// </summary>
        /// <param name="settings"><see cref="TrustscanSettings"/>.</param>
        ...
        public TrustscanService(
            IOptions<TrustscanSettings> settings,
            ...
            where TTransactionIntervalData : class, ITransactionIntervalData
        {
            ...
            var transactions = (await _client.GetTransactionsAsync<TrustscanAccountNormalTransactions, TrustscanAccountNormalTransaction>(request.Address).ConfigureAwait(false)).ToList();
            var erc20Tokens = (await _client.GetTransactionsAsync<TrustscanAccountERC20TokenEvents, TrustscanAccountERC20TokenEvent>(request.Address).ConfigureAwait(false)).ToList();
