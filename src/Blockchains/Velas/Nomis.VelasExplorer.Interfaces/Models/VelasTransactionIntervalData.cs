// ------------------------------------------------------------------------------------------------------
// <copyright file="VelasTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.VelasExplorer.Interfaces.Models
{
    ...
    public class VelasTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToVlx();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToVlx();
        ...
        public decimal AmountInSumValue => AmountInSum.ToVlx();
