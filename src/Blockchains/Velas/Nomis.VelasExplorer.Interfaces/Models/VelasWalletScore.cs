// ------------------------------------------------------------------------------------------------------
// <copyright file="VelasWalletScore.cs" company="Nomis">
...
namespace Nomis.VelasExplorer.Interfaces.Models
{
    ...
    /// Velas wallet score.
    /// </summary>
    public class VelasWalletScore :
        IWalletScore<VelasWalletStats, VelasTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public VelasWalletStats? Stats { get; set; }
    }
}