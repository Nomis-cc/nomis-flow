// ------------------------------------------------------------------------------------------------------
// <copyright file="VelasStatCalculator.cs" company="Nomis">
...
namespace Nomis.VelasExplorer.Calculators
{
    /// <summary>
    /// Velas wallet stats calculator.
    /// </summary>
    internal sealed class VelasStatCalculator :
        IStatCalculator<VelasWalletStats, VelasTransactionIntervalData>
    {
        private readonly string _address;
        private readonly decimal _balance;
        private readonly decimal _usdBalance;
        private readonly IEnumerable<VelasExplorerAccountNormalTransaction> _transactions;
        private readonly IEnumerable<VelasExplorerAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        public VelasStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<VelasExplorerAccountNormalTransaction> transactions,
            IEnumerable<VelasExplorerAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        public VelasWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToVlx() : 0),
                BalanceChangeInLastMonth = IStatCalculator<VelasTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<VelasTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
