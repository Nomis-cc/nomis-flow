...
using Nomis.WavesExplorer.Interfaces.Requests;
...
namespace Nomis.Api.Waves
{
        ...
        ControllerBase
    {
        ...
        /// Sample request:
        ///
        ///     GET /api/v1/waves/wallet/3P54ZaN6zfVhzTD8yYkrZWqbPXtMRnzHb3Y/score?scoreType=0&amp;nonce=0&amp;deadline=133160867380732039
        /// </remarks>
        ...
        public async Task<IActionResult> GetWavesWalletScoreAsync(
            [Required(ErrorMessage = "Request should be set")] WavesWalletStatsRequest request,
            CancellationToken cancellationToken = default)
        {
            switch (request.ScoreType)
            {
                case ScoreType.Finance:
                    return Ok(await _scoringService.GetWalletStatsAsync<WavesWalletStatsRequest, WavesWalletScore, WavesWalletStats, WavesTransactionIntervalData>(request, cancellationToken));
                default:
