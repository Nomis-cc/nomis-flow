...
namespace Nomis.WavesExplorer.Interfaces.Models
{
    ...
    /// Waves wallet stats.
    /// </summary>
    public sealed class WavesWalletStats :
        IWalletCommonStats<WavesTransactionIntervalData>,
        ...
        IWalletContractStats
    {
        ...
        /// <inheritdoc/>
        public string NativeToken => "Waves";
        ...
        /// <inheritdoc/>
        public IEnumerable<WavesTransactionIntervalData>? TurnoverIntervals { get; init; }
        ...
        public IEnumerable<string> ExcludedStatDescriptions =>
            IWalletCommonStats<WavesTransactionIntervalData>.ExcludedStatDescriptions.Union(new List<string>
            {
